...
urlpatterns = patterns('',
                       ...
                       url(r'^populate_db_with_small_data',
                           views.populate_db_with_small_data,
                           name='populate_db_with_small_data'),
                       url(r'^populate_db_with_big_data',
                           views.populate_db_with_big_data,
                           name='populate_db_with_big_data'),
)
