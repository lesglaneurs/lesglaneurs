...
NAME="lesglaneurs_master"     
PROJECT_NAME=lesglaneurs                       # Name of the application
DJANGO_DIR=/webapps/django/lesglaneurs_master          # Django project directory
SOCKFILE=/webapps/django/run/gunicorn_master.sock        # to handled shared file system with VM
